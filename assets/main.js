  ...
  $('.js-form').submit(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        showModal('Comment submitted', 'Thanks! Your comment is <a href="https://github.com/shubhamrasal/shubhamrasal.github.io/blog/pulls">pending</a>. It will appear when approved.');
